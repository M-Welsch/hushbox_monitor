...
<form action="/change_values">
  <table>
    ...
    <tr><td>New Overtemperature Hysteresis 0</td><td><input type="text" name="ot_hyst0" placeholder="new value ..."></td></tr>
    <tr><td>New Overtemperature Hysteresis 1</td><td><input type="text" name="ot_hyst1" placeholder="new value ..."></td></tr>
